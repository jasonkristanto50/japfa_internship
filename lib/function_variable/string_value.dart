// Confirmation Dialog
String confirmationTitleValue = "Pengajuan Berhasil Dikirim";
String confirmationMessageValue =
    "\nSilahkan cek status pengajuan secara berkala dengan melakukan login menggunakan TOKEN yang diberikan melalui EMAIL\n";

// Pengajuan
String pengajuanSuksesValue = "Pengajuan anda berhasil terkirim";

...
class DepartmentCard extends ConsumerStatefulWidget {
  ...
  final String image;
  final List<String> requirements; // Add a list for requirements

  const DepartmentCard({
    required this.title,
    required this.description,
    required this.image,
    required this.requirements, // Add this parameter
    super.key,
  });
...
class _DepartmentCardState extends ConsumerState<DepartmentCard> {
  bool isHovered = false; // Track if the card is hovered
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                // Scrollable description and requirements
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        ...widget.requirements.map((requirement) => Text(
                            requirement,
                ...
                Row(
                  children: [
                    ...
                    RoundedRectangleButton(
                        ...
                        height: 30,
                        style: regular16,
                        onPressed: applyOnPressedFunction),
                  ],
                ),
              ],
            ),
